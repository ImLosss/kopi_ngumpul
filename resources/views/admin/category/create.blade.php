...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('category.index') }}">Categories</a></li>
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <div class="@error('name')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" placeholder="Electronics" name="name" value="{{ old('category') }}" autofocus>
                                @error('name')
