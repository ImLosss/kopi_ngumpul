...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Record</li>
        </ol>
...
<div class="col-lg mb-lg-0 mb-4">
    <div class="card">
        ...
        <div class="card-body pt-4 p-3">
            <form action="{{ route('sales-record.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
