...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('orderAccess')
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#documentSideMenu" class="nav-link {{ (Request::is('order','order/*') ? 'active' : 'collapsed') }}" aria-controls="documentSideMenu"
                    role="button" aria-expanded="{{ (Request::is('order','order/*') ? 'true' : 'false') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-clipboard-list {{ (Request::is('order', 'order/*') ? '' : 'text-dark') }} text-sm"></i>
                    </div>
                    <span class="nav-link-text ms-1">Pesanan</span>
                </a>
                <div class="collapse {{ (Request::is('order','order/*') ? 'show' : '') }}" id="documentSideMenu" style="">
                    <ul class="nav ms-4 ps-3">
                        ...
                        @can('paymentAccess')
                        <li class="nav-item ">
                            <a class="nav-link {{ (Request::is('order/pembayaran') ? 'active' : '') }}" href="#">
                                <span class="sidenav-mini-icon"> P </span>
